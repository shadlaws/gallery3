...
class Gallery_Controller_Reauthenticate extends Controller {
  public function action_index() {
    ...
    if ($is_ajax) {
      $v = View::factory("gallery/reauthenticate.html");
      $v->form = self::_form();
  ...
  private static function _show_form($form) {
    $view = View_Theme::factory("required/page.html", "other", "reauthenticate");
    $view->page_title = t("Re-authenticate");
    $view->content = View::factory("gallery/reauthenticate.html");
