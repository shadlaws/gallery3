...
<div id="g-admin-graphics" class="g-block ui-helper-clearfix">
  ...
  <div class="g-block-content">
    ...
    <? if ($active == "none"): ?>
    <?= View::factory("admin/graphics_none.html") ?>
    <? else: ?>
    <?= View::factory("admin/graphics_$active.html", array("tk" => $tk->$active, "is_active" => true)) ?>
    <? endif ?>
    ...
    <div class="g-available">
      ...
      <? if ($id != $active): ?>
      <?= View::factory("admin/graphics_$id.html", array("tk" => $tk->$id, "is_active" => false)) ?>
      <? endif ?>
      <? endforeach ?>
    </div>
  </div>
