  ...
  <div class="g-block-content">
    <div id="g-site-theme">
      ...
      <div class="g-block g-selected ui-helper-clearfix">
        ...
        <? $v = View::factory("admin/themes_buttonset.html"); $v->info = $themes[$site]; print $v; ?>
      </div>
      ...
      <div class="g-available">
        ...
        <div class="g-block ui-helper-clearfix">
          ...
          <? $v = View::factory("admin/themes_buttonset.html"); $v->info = $info; print $v; ?>
        </div>
        <? $count++ ?>
        <? endforeach ?>
    ...
    <div id="g-admin-theme">
      ...
      <div class="g-block g-selected ui-helper-clearfix">
        ...
        <? $v = View::factory("admin/themes_buttonset.html"); $v->info = $themes[$admin]; print $v; ?>
      </div>
